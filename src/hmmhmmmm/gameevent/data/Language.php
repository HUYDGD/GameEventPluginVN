...
class Language{
   ...
   private $langEnglish = [
      ...
      "gameevent.command.start.usage" => "/gameevent start <người chơi> <EventName>",
      ...
      "gameevent.command.award.usage" => "/gameevent award <người chơi> <EventName>",
   ...
   private $langVietnamese = [
      "reset" => false,
      "notfound.plugin" => "§cPlugin này sẽ không hoạt động nếu không có %s",
      "notfound.libraries" => "§cKhông tìm thấy thư viện %s, vui lòng cài đặt plugin này ở dạng .phar (Lên kênh Sói tải đi nhé)",
      "plugininfo.name" => "§fTên plugin: %s",
      "plugininfo.version" => "§fPhiên bản: %s",
      "plugininfo.author" => "§fTác giả: %s",
      "plugininfo.description" => "§fGiới thiệu: §eLà một plugin miễn phí. Đừng bao giờ đem nó đi bán!! Nếu bạn sử dụng nó cho những mục đích khác, vui lòng ghi lại credits để tôn trọng quyền tác giả. :)",
      "plugininfo.facebook" => "§fFacebook: %s",
      "plugininfo.youtube" => "§fYoutube: %s",
      "plugininfo.website" => "§fWebsite: %s",
      "plugininfo.discord" => "§fDiscord: %s",
      "event.title" => "",
      "event.without" => "§cKhông có sự kiện nào cả",
      "event.notfound" => "§cKhông tìm thấy sự kiện mang tên %s",
      "event.off" => "§cSự kiện này đã kết thúc.",
      "sign.award.noprefix" => "[Nhận Phần Thưởng]",
      "sign.award.prefix" => "§b[§eNhận Phần Thưởng§b]",
      "sendtime.msgday" => "ngày",
      "sendtime.msghours" => "giờ",
      "sendtime.msgminutes" => "phút",
      "sendtime.msgseconds" => "giây",
      "makeslapper" => "§aSlapper đã được tạo thành công.",
      "enabledevent.on" => "§aSự kiện %s đã bắt đầu!",
      "enabledevent.off" => "§cSự kiện %s đã kết thúc!",
      "infostartevent.on" => "§l§6%s\nTrạng thái: §ađang diễn ra\nNội dung: §c%s\n§fThời gian còn lại: §e%s\n§fPhần thưởng: §d%s",
      "infostartevent.off" => "\n§l§6%s\nTrạng thái: §cđã kết thúc",
      "infoawardevent.on" => "§a%s\n§fNhấn vào đây để nhận §b%s",
      "infoawardevent.off" => "§l§6%s\nTrạng thái: §cđã kết thúc",
      "playerstartevent.error1" => "§cBạn đã hoàn thành sự kiện này rồi! Vui lòng quay lại sau.",
      "playerstartevent.welcome" => "Chào mừng bạn đã đến với sự kiện %s, sự kiện này sẽ kết thúc trong §b%s §fnữa, nếu hoàn thành bạn sẽ nhận được phần thưởng là §d%s",
      "playerawardevent.error1" => "§cBạn đã hoàn thành sự kiện này rồi! Vui lòng quay lại sau.",
      "playerawardevent.complete" => "Người chơi %s đã hoàn thành sự kiện %s và nhận được §b%s",
      "gameevent.command.consoleError" => "§cLỗi: lệnh này chỉ có thể dùng trong game, nứng à ?.",
      "gameevent.command.permissionError" => "§cLỗi: bạn không thể nhập lệnh này.",
      "gameevent.command.sendHelp.empty" => "§eBạn có thể xem tất cả lệnh bằng cách nhập /gameevent help",
      "gameevent.command.info.usage" => "/gameevent info",
      "gameevent.command.info.description" => "§fXem thông tin tác giả",
      "gameevent.command.create.usage" => "/gameevent create <tên sự kiện> <thời gian> <nội dung> <tên phần thưởng>",
      "gameevent.command.create.description" => "§fTạo sự kiện mới",
      "gameevent.command.create.error1" => "§cLỗi: %s",
      "gameevent.command.create.error2" => "§cSự kiện %s đã được tạo!",
      "gameevent.command.create.error3" => "§cLỗi: hãy viết thời gian bằng con số.",
      "gameevent.command.create.complete" => "§aHãy nhập lệnh bắt đầu sự kiện ở khung chat.",
      "gameevent.command.list.usage" => "/gameevent list",
      "gameevent.command.list.description" => "§fXem danh sách tất cả sự kiện.",
      "gameevent.command.list.error1" => "§cKhông có danh sách sự kiện.",
      "gameevent.command.list.complete" => "Danh sách tất cả sự kiện: §b%s",
      "gameevent.command.remove.usage" => "/gameevent remove <tên sự kiện>",
      "gameevent.command.remove.description" => "§fXóa bỏ sự kiện",
      "gameevent.command.remove.error1" => "§cLỗi: %s",
      "gameevent.command.remove.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.remove.complete" => "§aXóa thành công sự kiện %s",
      "gameevent.command.settime.usage" => "/gameevent settime <tên sự kiện> <thời gian>",
      "gameevent.command.settime.description" => "§fĐặt thời gian cho sự kiện",
      "gameevent.command.settime.error1" => "§cLỗi: %s",
      "gameevent.command.settime.error2" => "§Không tìm thấy tên của sự kiện %s",
      "gameevent.command.settime.error3" => "§cLỗi: hãy viết thời gian bằng con số.",
      "gameevent.command.settime.complete" => "§aĐặt thời gian cho sự kiện %s thành %s thành công.",
      "gameevent.command.setpresent.usage" => "/gameevent setpresent <tên sự kiện>",
      "gameevent.command.setpresent.description" => "§fĐặt sự kiện hiện tại.",
      "gameevent.command.setpresent.error1" => "§cLỗi: %s",
      "gameevent.command.setpresent.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.setpresent.complete" => "§aĐã đặt %s là sự kiện hiện tại thành công!",
      "gameevent.command.setnext.usage" => "/gameevent setnext <tên sự kiện>",
      "gameevent.command.setnext.description" => "§fĐặt một sự kiện tiếp theo.",
      "gameevent.command.setnext.error1" => "§cLỗi: %s",
      "gameevent.command.setnext.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.setnext.complete" => "§aĐã đặt %s là sự kiện tiếp theo thành công!",
      "gameevent.command.enabled.usage" => "/gameevent enabled <tên sự kiện> on|off",
      "gameevent.command.enabled.description" => "§fBật/Tắt một sự kiện.",
      "gameevent.command.enabled.error1" => "§cLỗi: %s",
      "gameevent.command.enabled.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.enabled.error3" => "§cBạn chưa đặt %s là sự kiện hiện tại.",
      "gameevent.command.start.usage" => "/gameevent start <người chơi> <tên sự kiện>",
      "gameevent.command.start.description" => "§fCho một người chơi tham gia sự kiện.",
      "gameevent.command.start.error1" => "§cLỗi: %s",
      "gameevent.command.start.error2" => "§cKhông tìm thấy người chơi hoặc người chơi đó chưa online.",
      "gameevent.command.start.error3" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.start.error4" => "§cSự kiện đã kết thúc.",
      "gameevent.command.award.usage" => "/gameevent award <người chơi> <tên sự kiện>",
      "gameevent.command.award.description" => "§fThêm người chơi vào để nhận phần thưởng sự kiện.",
      "gameevent.command.award.error1" => "§cLỗi: %s",
      "gameevent.command.award.error2" => "§cKhông tìm thấy người chơi hoặc người chơi đó chưa online.",
      "gameevent.command.award.error3" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.award.error4" => "§cSự kiện đã kết thúc.",
      "gameevent.command.signstart.usage" => "/gameevent sign_start <tên sự kiện>",
      "gameevent.command.signstart.description" => "§fTạo bảng để bắt đầu sự kiện.",
      "gameevent.command.signstart.error1" => "§cLỗi: %s",
      "gameevent.command.signstart.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.signstart.complete" => "Nhấn vào bảng để tạo.",
      "gameevent.command.signaward.usage" => "/gameevent sign_award <tên sự kiện>",
      "gameevent.command.signaward.description" => "§fTạo một cái bảng để nhận thưởng.",
      "gameevent.command.signaward.error1" => "§cLỗi: %s",
      "gameevent.command.signaward.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.signaward.complete" => "Nhấn vào bảng để tạo.",
      "gameevent.command.slapperstart.usage" => "/gameevent slapper_start <tên sự kiện>",
      "gameevent.command.slapperstart.description" => "§fTạo một slapper để bắt đầu sự kiện.",
      "gameevent.command.slapperstart.error1" => "§cLỗi: %s",
      "gameevent.command.slapperstart.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.slapperaward.usage" => "/gameevent slapper_award <tên sự kiện>",
      "gameevent.command.slapperaward.description" => "§fTạo một slapper để nhận thưởng.",
      "gameevent.command.slapperaward.error1" => "§cLỗi: %s",
      "gameevent.command.slapperaward.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.welcome.usage" => "/gameevent welcome <tên sự kiện>",
      "gameevent.command.welcome.description" => "§fBật/Tắt tin nhắn chào mừng khi tham gia sự kiện.",
      "gameevent.command.welcome.error1" => "§cLỗi: %s",
      "gameevent.command.welcome.error2" => "§cKhông tìm thấy tên của sự kiện %s",
      "gameevent.command.welcome.on" => "Sự kiện %s đã được §abật §ftin nhắn chào mừng.",
      "gameevent.command.welcome.off" => "Sự kiện %s đã được §ctắt §ftin nhắn chào mừng.",
      "listener.playerchat.create.event.commandstart1" => "Lệnh bắt đầu sự kiện: §b%s",
      "listener.playerchat.create.event.commandstart2" => "Hãy nhập lệnh nhận thưởng.",
      "listener.playerchat.create.event.commandaward1" => "Lệnh nhận thưởng: §e%s",
      "listener.playerchat.create.event.complete" => "§aSự kiện %s được tạo thành công.",
      "listener.playerchat.create.event.error1" => "§cSự kiện %s sẽ không được tạo vì không tìm thấy %s",
      "listener.playerinteract.create.signstart.complete" => "§aTạo bảng sự kiện thành công.",
      "listener.playerinteract.create.signstart.error1" => "§cHãy nhấn vào bảng.",
      "listener.playerinteract.create.signaward.complete" => "§aTạo bảng nhận thưởng thành công.",
      "listener.playerinteract.create.signaward.error1" => "§cHãy nhấn vào bảng.",
      "scheduler.runsignevent.sign.timeon" => "§fCòn lại: §a%s",
      "scheduler.runsignevent.sign.award" => "§fPhần thưởng: §b%s",
      "scheduler.runevent.new" => "§fSẽ bắt đầu sự kiện mới trong: §a%s",
      "scheduler.runevent.willend" => "Sự kiện %s sẽ kết thúc trong: §b%s %s",
      "scheduler.runevent.end" => "Sự kiện %s §cđã kết thúc.",
      "form.menu.button1" => "§aTạo sự kiện mới.",
      "form.create.input1" => "§eTên sự kiện",
      "form.create.input2" => "§eThời gian (tính = giây)",
      "form.create.input3" => "§eNội dung",
      "form.create.input4" => "§ePhần thưởng",
      "form.create.input5" => "§eLệnh bắt đầu sự kiện (ex: /warp, /tp,..)",
      "form.create.input6" => "§eLệnh đưa phần thưởng (ex: /give, /enchant,..)",
      "form.create.error1" => "§cLỗi\n§eHãy nhập tên sự kiện.",
      "form.create.error2" => "§cLỗi\n§eTên %s đã tồn tại.",
      "form.create.error3" => "§cLỗi\n§eYêu cầu viết bằng số.",
      "form.create.error4" => "§cLỗi\n§eCần phải đặt %s",
      "form.edit.info.on" => "§aĐã bật",
      "form.edit.info.off" => "§cĐã tắt",
      "form.edit.info.yes" => "§aCó",
      "form.edit.info.no" => "§cKhông",
      "form.edit.content" => "§fThông tin: §e%s\n§fTrạng thái: %s\n§fĐặt là sự kiện hiện tại: %s\n§fĐặt là sự kiện tiếp theo: %s\n§fĐặt thời gian: §b%s",
      "form.edit.button1" => "§fChỉnh sửa sự kiện",
      "form.edit.button2" => "§aBật§f/§cTắt §fsự kiện",
      "form.edit.button3" => "§fĐặt là sự kiện hiện tại",
      "form.edit.button4" => "§fĐặt là sự kiện tiếp theo",
      "form.edit.button5" => "§fĐặt thời gian cho sự kiện",
      "form.edit.button6" => "§fTạo bảng bắt đầu sự kiện",
      "form.edit.button7" => "§fTạo bảng nhận thưởng",
      "form.edit.button8" => "§fTạo slapper bắt đầu sự kiện",
      "form.edit.button9" => "§fTạo slapper nhận thưởng",
      "form.edit.button10" => "§aBật§f/§cTắt §ftin nhắn chào mừng",
      "form.edit.button11" => "§c[Xóa sự kiện]",
      "form.edit2.complete" => "§aSự kiện %s đã được sửa lại.",
      "form.remove.content" => "§fXác nhận xóa sự kiện §a%s",
      "form.remove.yes" => "§aCó",
      "form.remove.no" => "§cKhông"
   ...
   public function reset(): void{
	  ...
	  if($this->getLang() == "vietnamese"){
         foreach($this->langVietnamese as $key => $value){
            $data->setNested($key, $value);
		 }
	  }
      $data->save();
